...
def file_name(file_dir):   
    ...
    return L  
image_sets=file_name('C:/Users/cjz97/Desktop/picture1/c0');#图片存贮路径
#添加噪声
def add_noise(img):
...
def creat_dataset(image_num = 100, mode = 'original'):
    ...
    for i in tqdm(range(len(image_sets))):
        count = 0
        src_img = Image.open('C:/Users/cjz97/Desktop/picture1/c0/' + image_sets[i])  # 3 channels
        label_img = Image.open('C:/Users/cjz97/Desktop/picture1/c0_mask/' + image_sets[i]) # 3 channels
        #对图像进行随机裁剪，这里大小为512*512       
        while count < image_each:
            ...
            src_roi.save('C:/Users/cjz97/Desktop/picture1/c0/%d.jpg' % g_count)
            label_roi.save('C:/Users/cjz97/Desktop/picture1/c0_mask/%d.jpg' % g_count)
            count += 1 
            g_count += 1
